...
from aeo.reports import write_csv, write_json, write_pdf, write_responses_md, write_xlsx
...
def generate_reports(record: RunRecord, store: RunStore) -> dict[str, str]:
    """Write XLSX, CSV, JSON, PDF, and the raw-responses Markdown into the run
    folder; return {format: path}."""
    ...
    paths = {
        ...
        "md": str(write_responses_md(record, run_dir / "responses.md")),
    }
